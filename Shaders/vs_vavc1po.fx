...
VS_OUT main(VS_IN i)
{
	...
	r2.x = dot(r0, transpose(g_View)[0]);
	r2.y = dot(r0, transpose(g_View)[1]);
	r2.z = dot(r0, transpose(g_View)[2]);
	r0.w = dot(r0, transpose(g_View)[3]);
	r2.xyz = -r2.xyz + r3.xyz;
	r1.w = dot(r2.xyz, r2.xyz);
	r2.x = dot(g_refBaseVec.xyz, r2.xyz);
	r1.w = g_refBasePos.w * -g_refBasePos.w + r1.w;
	r1.w = r2.x * r2.x + -r1.w;
	r1.w = 1 / sqrt(r1.w);
	r1.w = 1 / r1.w;
	r1.w = -r1.w + -r2.x;
	r1.w = min(r1.w, 0);
	r0.xyz = g_refBaseVec.xyz * r1.www + r3.xyz;
