...
float4 main(PS_IN i) : COLOR
{
	...
	r3.w = (-abs(r1.w) >= 0) ? 0 : 1;
	r4.w = (-r2.w >= 0) ? 0 : r3.w;
	r5.x = pow(r2.w, specularParam.z);
	r2.w = r4.w * r5.x;
	r3.w = abs(r1.w) * r3.w;
	r5.xyz = abs(r1.www) * point_light1.xyz;
	r5.xyz = r1.yyy * r5.xyz;
	...
	r2.w = r4.w * r5.w;
	r3.w = abs(r1.w) * r3.w;
	r8.xyz = r3.www * point_lightEv0.xyz;
	r8.xyz = r2.www * r8.xyz;
	r8.xyz = r1.yyy * r8.xyz;
	...
	r5.xyz = r4.xyz * point_lightEv0.xyz;
	r5.xyz = abs(r1.www) * r5.xyz;
	r5.xyz = r1.yyy * r5.xyz;
	r5.xyz = r7.zzz * r5.xyz;
	r3.xyz = r4.xyz * r3.xyz + r5.xyz;
	r5.xyz = r4.xyz * point_lightEv1.xyz;
	r5.xyz = abs(r3.www) * r5.xyz;
	r5.xyz = r2.www * r5.xyz;
	r3.xyz = r5.xyz * r7.www + r3.xyz;
	r5.xyz = r4.xyz * point_lightEv2.xyz;
	r5.xyz = abs(r6.www) * r5.xyz;
	r5.xyz = r5.www * r5.xyz;
	r6.x = 2;
	r1.y = r6.x + -g_specCalc2.x;
	...
	r5 = lerp(r2, r3, g_CubeBlendParam.x);
