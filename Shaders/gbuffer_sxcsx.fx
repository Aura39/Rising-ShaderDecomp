...
PS_OUT main(PS_IN i)
{
	...
	r1.x = r1.x + 0.5;
	r2.xy = float2(0.5, 1);
	r1.y = r1.w * g_olcParam.w + r2.x;
	r1.z = frac(r1.y);
	r1.y = -r1.z + r1.y;
	r1.z = r2.x + g_olcParam.y;
	r1.w = frac(r1.z);
	r1.z = -r1.w + r1.z;
	r1.z = 1 / r1.z;
	r1.y = r1.y * -r1.z + 1;
	...
	r2.xzw = r0.www * r3.xyz;
	r2.xzw = r2.xzw * g_cubeParam.yyy;
	r3.xyz = r3.www * r2.xzw;
	r3.xyz = r3.xyz * g_cubeParam2.yyy;
	r2.xzw = r2.xzw * g_cubeParam2.xxx + r3.xyz;
	...
	r1.xzw = r3.xyz * r1.xxx + r2.xzw;
	r2.xzw = r0.xyz * g_lightColor.xyz;
	o.color.xyz = r0.xyz;
	o.color2.xyz = r2.xzw * r1.yyy + r1.xzw;
	o.color.w = 1;
