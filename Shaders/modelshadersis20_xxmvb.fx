...
float4 main(PS_IN i) : COLOR
{
	...
	r5 = tex2D(Color_1_sampler, r4.zwzw);
	r4 = tex2D(A_Occ_sampler, r4);
	r1.xz = -r5.yy + r5.xz;
	r0.w = max(abs(r1.x), abs(r1.z));
	r0.w = r0.w + -0.015625;
	r1.x = (-r0.w >= 0) ? 0 : 1;
	...
	r0.w = r0.w + r1.x;
	r0.w = (r0.w >= 0) ? -r0.w : -0;
	r5.xz = (r0.ww >= 0) ? r5.yy : r5.xz;
	r0.w = r2.w * i.color.w;
	r1.xzw = lerp(r2.xyz, r5.xyz, r0.www);
	...
	r3.xyz = r1.xzw * r4.xyz;
	r1.xzw = r1.xzw * r2.xyz;
	r0.xyz = r0.xyz * r1.xzw;
	r1.xzw = r3.xyz * ambient_rate.xyz;
