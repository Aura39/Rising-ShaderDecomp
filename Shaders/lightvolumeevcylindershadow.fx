...
float4 main(float4 texcoord : TEXCOORD) : COLOR
{
	...
	r0.w = r4.z * -0.25 + r0.w;
	r4.y = r0.w * 4;
	r5 = tex2D(g_SpecPowSampler, r4);
	r0.w = pow(r2.y, r2.z);
	r2.z = (-r1.w >= 0) ? 0 : 1;
	r2.y = (-r2.y >= 0) ? 0 : r2.z;
	r2.z = r1.w * r2.z;
	r0.w = r0.w * r2.y;
	r4.xyw = r2.zzz * -r0.www + r5.xyz;
	r0.w = r0.w * r2.z;
	r3.yzw = r3.yyy * r4.xyw + r0.www;
	...
	r1.xyz = r0.www * g_LightCol.xyz;
	r1.xyz = r3.xxx * r1.xyz;
	r2.xyz = r3.yzw * r1.xyz;
	...
	r0 = tex2D(g_ShadowSampler, r0);
	r0.x = -r0.z + 1;
	r0.yzw = r4.zzz + r3.xyz;
	r0.yzw = r0.yzw * r2.xyz;
	r0.yzw = r3.xyz * r1.xyz + r0.yzw;
	r1.x = r1.w + r3.w;
