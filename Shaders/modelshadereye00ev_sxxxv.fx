...
float4 main(PS_IN i) : COLOR
{
	...
	float4 r5;
	float4 r6;
	r0.xyz = point_lightpos2.xyz + -i.texcoord1.xyz;
	...
	r0.xyz = r1.xxx * point_light2.xyz;
	r0.xyz = r0.www * r0.xyz;
	...
	r1.xyz = r2.xxx * point_light1.xyz;
	r1.xyz = r0.www * r1.xyz;
	r2.x = 2;
	r2.xy = r2.xx + -g_specCalc1.xy;
	r1.xyz = r1.xyz * r2.xxx + i.texcoord2.xyz;
