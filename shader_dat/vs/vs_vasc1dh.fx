...
VS_OUT main(VS_IN i)
{
	...
	r2.z = 0.1;
	r2.x = r1.y * -g_SkyHemisphereColor.w + r2.z;
	r2.xyw = r2.xxx * g_GroundHemisphereColor.xyz;
	r2.z = r1.y * g_SkyHemisphereColor.w + r2.z;
	o.texcoord5 = g_SkyHemisphereColor.xyz * r2.zzz + r2.xyw;
