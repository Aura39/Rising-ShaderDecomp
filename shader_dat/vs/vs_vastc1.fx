...
VS_OUT main(VS_IN i)
{
	...
	r2.x = dot(r1.xyz, transpose(g_WorldView)[0].xyz);
	r2.y = dot(r1.xyz, transpose(g_WorldView)[1].xyz);
	r2.z = dot(r1.xyz, transpose(g_WorldView)[2].xyz);
	r0.w = dot(r2.xyz, r2.xyz);
	r0.w = 1 / sqrt(r0.w);
	o.texcoord2.xyz = r0.www * r2.xyz;
