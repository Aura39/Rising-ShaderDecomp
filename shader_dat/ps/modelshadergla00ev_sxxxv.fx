...
float4 main(PS_IN i) : COLOR
{
	...
	r1.w = r2.w * r3.w;
	r6.xyz = r0.www * point_light1.xyz;
	...
	r1.w = r3.w * r4.w;
	r2.w = abs(r0.w) * r2.w;
	r6.xyz = abs(r0.www) * point_light2.xyz;
	r6.xyz = r0.yyy * r6.xyz;
	...
	r0.y = 1 / sqrt(r0.y);
	r9.xyz = r8.xyz * r0.yyy + r4.xyz;
	r8.xyz = r0.yyy * r8.xyz;
	r0.y = 1 / r0.y;
	r0.y = -r0.y + point_lightposEv0.w;
	r0.y = r0.y * point_lightEv0.w;
	r0.w = dot(r8.xyz, i.texcoord3.xyz);
	...
	r3.yzw = g_specCalc1.yzw;
	r3.xyz = -r3.yzw + 2;
	r4.xyz = r6.xyz * r3.xxx + i.texcoord2.xyz;
	r1.xyz = r1.xyz * r0.xxx + r4.xyz;
	r3.xw = -r5.yy + r5.xz;
	r0.x = max(abs(r3.x), abs(r3.w));
	r0.x = r0.x + -0.015625;
	r3.x = (-r0.x >= 0) ? 0 : 1;
	r0.x = (r0.x >= 0) ? -0 : -1;
	r0.x = r0.x + r3.x;
	...
	r3.xyw = r3.yyy * r4.xyz;
	r1.xyz = r5.xyz * r1.xyz + r3.xyw;
	r3.xyw = r5.xyz * point_lightEv1.xyz;
	r3.xyw = abs(r2.www) * r3.xyw;
	r3.xyw = r1.www * r3.xyw;
	r1.xyz = r3.xyw * r3.zzz + r1.xyz;
