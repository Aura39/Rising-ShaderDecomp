...
float4 main(PS_IN i) : COLOR
{
	...
	r2.x = r2.x + 1;
	r2.x = r2.x * 0.5 + 0.5;
	r4 = g_All_Offset.xyxy + i.texcoord.zwxy;
	r5 = tex2D(A_Occ_sampler, r4);
	r4 = tex2D(Color_1_sampler, r4.zwzw);
	r2.yz = -r5.yy + r5.xz;
	...
	r2.xyz = r1.xxx * r4.xyz;
	r1.xyz = r4.xyz * r1.xxx + specularParam.www;
