...
float4 main(PS_IN i) : COLOR
{
	...
	r4.w = -r2.w + 1;
	r6.x = r4.w * -specularParam.z + r2.w;
	...
	r5.x = -r4.w + 1;
	r6.z = r5.x * -specularParam.z + r4.w;
	...
	r2.y = 1 / r2.y;
	r2.z = dot(r4.xyz, lightpos.xyz);
	r2.z = r2.z + -spot_param.x;
	r2.x = r2.x * r2.z;
	r3.w = max(r2.z, 0);
	r2.z = 1 / spot_param.y;
	r2.x = r2.z * r2.x;
	...
	r2.y = r2.y * 10;
	r2.x = r2.y * r2.x;
	r4.x = lerp(r2.x, r3.w, spot_param.z);
	r2.xyz = r4.xxx * light_Color.xyz;
	r1.xyz = r2.xyz * r0.xxx + r1.xyz;
	r0.x = -r0.x + 1;
	r2.xy = -r3.yy + r3.xz;
