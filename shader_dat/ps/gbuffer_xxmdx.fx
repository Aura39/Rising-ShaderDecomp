...
PS_OUT main(PS_IN i)
{
	...
	o.color.w = r1.x;
	r1.xyw = r1.yyy * r2.yzw;
	r2.y = 0.1 + -i.texcoord3.w;
	r2.yzw = r2.yyy * g_GroundHemisphereColor.xyz;
	r3.x = 0.1 + i.texcoord3.w;
	r2.yzw = g_SkyHemisphereColor.xyz * r3.xxx + r2.yzw;
