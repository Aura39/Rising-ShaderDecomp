...
PS_OUT main(PS_IN i)
{
	...
	r0.z = dot(g_lightDir.xyz, r5.xyz);
	r5.xyz = normalize(r4.xyz);
	o.color1.xyz = r5.xyz * 0.5 + 0.5;
	r4.xyz = i.texcoord4.xyz;
	r6.xyz = r4.zxy * i.texcoord5.yzx;
	r4.xyz = r4.yzx * i.texcoord5.zxy + -r6.xyz;
	r4.xyz = r4.xyz * r8.yyy;
	r4.xyz = r8.xxx * i.texcoord4.xyz + r4.xyz;
	r4.xyz = r8.zzz * i.texcoord5.xyz + r4.xyz;
	r0.w = dot(i.texcoord6.xyz, r4.xyz);
	r0.w = r0.w + r0.w;
	r4.xyz = r4.xyz * -r0.www + i.texcoord6.xyz;
	r4.w = -r4.z;
	r4 = tex2D(g_CubeSampler, r4.xyww);
	r4 = r0.y * r4;
	r0.x = g_cubeParam.w * r3.y + r0.x;
	r0.xyw = r0.xxx * r4.xyz;
	r0.xyw = r0.xyw * g_cubeParam.yyy;
	r3.yzw = r4.www * r0.xyw;
	r3.yzw = r3.yzw * g_cubeParam2.yyy;
	r0.xyw = r0.xyw * g_cubeParam2.xxx + r3.yzw;
