...
PS_OUT main(PS_IN i)
{
	...
	r2.w = (-r2.w >= 0) ? 0 : 0.25;
	r3.y = g_specParam.y;
	r3.x = r3.y + g_otherParam.x;
	o.color1.w = r2.w + r3.x;
	r2.w = abs(g_specParam.x);
	r3 = tex2D(g_MaskSampler, i.texcoord8.zwzw);
	r5.xyz = lerp(r2.zzz, r3.xyz, g_specParam.www);
	r3.xyz = g_cubeParam.zzz * r3.xyz + g_cubeParam.xxx;
	r3.xyz = g_cubeParam.www * r2.yyy + r3.xyz;
	r2.y = dot(r5.xyz, 0.298912);
	o.color3.z = r2.w * r2.y;
	r5.xyz = i.texcoord4.xyz;
	r2.yzw = r5.zxy * i.texcoord5.yzx;
	r2.yzw = r5.yzx * i.texcoord5.zxy + -r2.yzw;
	r2.yzw = r2.yzw * r7.yyy;
	r2.yzw = r7.xxx * i.texcoord4.xyz + r2.yzw;
	r2.yzw = r7.zzz * i.texcoord5.xyz + r2.yzw;
	r3.w = dot(i.texcoord6.xyz, r2.yzw);
	r3.w = r3.w + r3.w;
	r5.xyz = r2.yzw * -r3.www + i.texcoord6.xyz;
	r5.w = -r5.z;
	r5 = tex2D(g_CubeSampler, r5.xyww);
	r5 = r0.x * r5;
	r2.yzw = r3.xyz * r5.xyz;
	r2.yzw = r2.yzw * g_cubeParam.yyy;
	r3.xyz = r5.www * r2.yzw;
