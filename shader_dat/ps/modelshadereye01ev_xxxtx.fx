...
float4 main(PS_IN i) : COLOR
{
	...
	r0.w = -r0.z;
	r2 = tex2D(cubemap_sampler, r0.xyww);
	r0 = tex2D(cubemap2_sampler, r0.xyww);
	r3 = lerp(r0, r2, g_CubeBlendParam.x);
	...
	r4.x = -r3.w + 1;
	r4.z = r4.x * -specularParam.z + r3.w;
	r4.yw = specularParam.yy;
	r5 = tex2D(Spec_Pow_sampler, r4.zwzw);
	r5.xyz = r5.xyz * g_eyeLightDir2.www;
	r6.xyz = normalize(-g_eyeLightDir.xyz);
	r1.x = dot(r6.xyz, r1.xyz);
	r1.y = -r1.x + 1;
	r4.x = r1.y * -specularParam.z + r1.x;
	r4 = tex2D(Spec_Pow_sampler, r4);
	r1.xyz = r4.xyz * g_eyeLightDir.www + r5.xyz;
