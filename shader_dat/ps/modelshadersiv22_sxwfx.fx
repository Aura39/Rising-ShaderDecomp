...
float4 main(PS_IN i) : COLOR
{
	...
	r5.xy = r2.ww * i.texcoord7.xy;
	r5.xy = r5.xy * float2(0.5, -0.5) + 0.5;
	r5.xy = r5.xy + g_TargetUvParam.xy;
	r5 = tex2D(ShadowCast_Tex_sampler, r5);
	r2.w = i.texcoord7.z * g_ShadowFarInvPs.y + -g_ShadowFarInvPs.x;
	r2.w = -r2.w + 1;
	r2.w = -r5.x + r2.w;
	r2.w = r2.w + g_ShadowUse.x;
	r3.w = frac(-r2.w);
	r2.w = r2.w + r3.w;
	r5.xyz = r0.www * light_Color.xyz;
	r5.xyz = r5.xyz * r2.www + i.texcoord2.xyz;
	...
	r3.w = r5.w * CubeParam.y + CubeParam.x;
