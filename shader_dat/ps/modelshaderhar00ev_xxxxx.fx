...
float4 main(PS_IN i) : COLOR
{
	...
	r8.xyz = (-r6.xzy >= 0) ? 0 : 1;
	r9.xyz = r2.xyz * r3.xxx + -i.texcoord1.xyz;
	...
	r3.y = abs(r4.x) * -aniso_shine.x + r3.y;
	r3.y = r3.y * r9.x;
	r4.x = (-r8.x >= 0) ? 0 : 1;
	r4.y = (-r3.y >= 0) ? 0 : r4.x;
	r4.z = pow(r3.y, specularParam.z);
	r3.y = r4.z * r4.y;
	r4.x = r8.x * r4.x;
	r4.xyz = r4.xxx * point_lightEv2.xyz;
	r4.xyz = r3.yyy * r4.xyz;
	r4.xyz = r8.www * r4.xyz;
	r0.xyz = r0.xyz * r4.xyz;
	r0.xyz = r0.xyz * r5.www + r2.xyz;
	r2.x = abs(specularParam.x);
	r0.xyz = r0.xyz * r2.xxx;
	r2.xy = -r1.yy + r1.xz;
	r3.y = max(abs(r2.x), abs(r2.y));
	r2.x = r3.y + -0.015625;
	r2.y = (-r2.x >= 0) ? 0 : 1;
	r2.x = (r2.x >= 0) ? -0 : -1;
	r2.x = r2.x + r2.y;
