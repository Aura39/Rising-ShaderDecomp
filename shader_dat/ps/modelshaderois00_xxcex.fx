...
float4 main(PS_IN i) : COLOR
{
	...
	r3.yzw = r1.xyz * r2.xyz;
	r1.xyz = r1.xyz + specularParam.www;
	r5.xyz = r3.yzw * CubeParam.zzz + r0.yzw;
	r3.yzw = r3.yzw * CubeParam.zzz;
	r0.yzw = r0.yzw * -r3.yzw + r5.xyz;
	r2.w = dot(-i.texcoord1.xyz, -i.texcoord1.xyz);
	r2.w = 1 / sqrt(r2.w);
	r3.yzw = -i.texcoord1.xyz * r2.www + lightpos.xyz;
	r5.xyz = normalize(r3.yzw);
	r2.w = dot(r5.xyz, r4.xyz);
	r3.y = pow(r2.w, specularParam.z);
	r3.z = (-r3.x >= 0) ? 0 : 1;
	r3.x = r3.x * r3.z;
	r2.w = (-r2.w >= 0) ? 0 : r3.z;
	r2.w = r3.y * r2.w;
