...
float4 main(PS_IN i) : COLOR
{
	...
	r4.yz = r4.yz * -r6.xy + 1;
	r3.w = r4.z * r4.y;
	r4.y = r3.w * 0.193754 + 0.5;
	r3.w = r3.w * 0.387508;
	r4.y = r4.y * r4.y + -r3.w;
	r3.w = hll_rate.x * r4.y + r3.w;
	r6.xyz = light_Color.xyz;
	r4.yzw = r6.xyz * aniso_diff_rate.xxx;
	r2.xyz = r4.yzw * r3.www + r2.xyz;
	r4.yz = -r1.yy + r1.xz;
	...
	r4.yzw = r1.xyz * ambient_rate.xyz;
	r1.xyz = r1.xyz + specularParam.www;
	r4.yzw = r4.yzw * ambient_rate_rate.xyz;
	r1.w = dot(lightpos.xyz, i.texcoord3.xyz);
	r1.w = -r1.w + r2.w;
	r1.w = r1.w + 1;
	r2.xyz = r4.yzw * r1.www + r2.xyz;
	r4.yzw = lightpos.xyz + -i.texcoord1.xyz;
