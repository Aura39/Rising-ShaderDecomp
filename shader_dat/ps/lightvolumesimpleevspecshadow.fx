...
float4 main(float4 texcoord : TEXCOORD) : COLOR
{
	...
	r3.z = max(r1.w, 0);
	r0.z = r0.z * r2.y;
	r4.xyw = r2.zzz * -r0.zzz + r5.xyz;
	r0.z = r0.z * r2.z;
	r4.xyw = r3.yyy * r4.xyw + r0.zzz;
	r0.z = lerp(g_lightHosei.y, g_lightHosei.x, r2.x);
	r1.xyz = r1.xyz;
	r0.z = (-r1.x >= 0) ? r0.z : g_lightHosei.z;
	r0.z = (-r1.y >= 0) ? r0.z : g_lightHosei.w;
	r0.z = (-r1.z >= 0) ? r0.z : g_lightHosei2.x;
	r1.xyz = r0.zzz * g_PointLightCol.xyz;
	r1.xyz = r3.xxx * r1.xyz;
	r1.xyz = r4.xyw * r1.xyz;
	r1.xyz = r2.www * r1.xyz;
	r0.z = 1 / g_PointLightCol.w;
	r0.z = r0.w * -r0.z + 1;
