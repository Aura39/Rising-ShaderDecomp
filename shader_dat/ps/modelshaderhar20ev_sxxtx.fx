...
float4 main(PS_IN i) : COLOR
{
	...
	r4.z = 1;
	r3.w = abs(r3.w) * -aniso_shine.x + r4.z;
	r6.x = r2.x * r3.w;
	r6.yw = specularParam.yy;
	r7 = tex2D(Spec_Pow_sampler, r6);
	r4.xyw = r7.xyz * light_Color.xyz;
	r4.xyw = r0.xyz * r4.xyw;
	...
	r5.w = abs(r5.w) * -aniso_shine.x + r4.z;
	r6.z = r3.w * r5.w;
	...
	r6.x = abs(r6.x) * -aniso_shine.x + r4.z;
	r6.x = r5.w * r6.x;
	r6.yw = specularParam.yy;
	...
	r6.y = abs(r6.y) * -aniso_shine.x + r4.z;
	r6.z = r6.y * r6.x;
	r6 = tex2D(Spec_Pow_sampler, r6.zwzw);
	r6.xyz = r6.xyz * point_lightEv0.xyz;
	r6.xyz = r5.www * r6.xyz;
	r6.xyz = r0.xyz * r6.xyz;
	r4.xyw = r6.xyz * r8.zzz + r4.xyw;
	...
	r10 = g_specCalc1;
	r10 = -r10 + 2;
	r2.yzw = r10.xxx * point_light1.xyz;
	r2.yzw = r2.yzw * aniso_diff_rate.xxx;
	r2.yzw = r1.www * r2.yzw;
	r2.xyz = r2.xxx * r2.yzw;
	r2.xyz = r10.xxx * r2.xyz;
	r4.xyw = muzzle_lightpos.xyz + -i.texcoord1.xyz;
	r1.w = dot(r4.xyw, r4.xyw);
	r1.w = 1 / sqrt(r1.w);
	r4.xyw = r1.www * r4.xyw;
	r1.w = 1 / r1.w;
	r1.w = -r1.w + muzzle_lightpos.w;
	r1.w = r1.w * muzzle_light.w;
	r9.z = dot(r4.xyw, i.texcoord3.xyz);
	r9.w = r7.w;
	r3.xz = r9.zw;
	r3.xz = r3.xz * -0.5 + 1;
	r4.xy = r3.xz * r3.xz;
	...
	r4.xyw = r3.xxx * muzzle_light.xyz;
	r4.xyw = r2.www * r4.xyw;
	r2.xyz = r4.xyw * r1.www + r2.xyz;
	r4.xy = r7.yw;
	r4.xy = r4.xy * -0.5 + 1;
	r5.xy = r4.xy * r4.xy;
	r5.xy = r5.xy * r5.xy;
	...
	r4.xyw = r10.yyy * point_light2.xyz;
	r4.xyw = r4.xyw * aniso_diff_rate.xxx;
	r4.xyw = r1.www * r4.xyw;
	r4.xyw = r3.www * r4.xyw;
	r2.xyz = r4.xyw * r10.yyy + r2.xyz;
	r1.w = r4.z + -spot_param.x;
	r1.w = 1 / r1.w;
	...
	r2.w = r2.w * 10;
	r1.w = r1.w * r2.w;
	r7.x = lerp(r1.w, r3.w, spot_param.z);
	r3.zw = r0.ww * r7.xw;
	r3.zw = r3.zw * -0.5 + 1;
	r4.xy = r3.zw * r3.zw;
	r4.xy = r4.xy * r4.xy;
