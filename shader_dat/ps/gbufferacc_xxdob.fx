...
PS_OUT main(PS_IN i)
{
	...
	r1.yzw = g_cubeParam.zzz * r4.xyz + g_cubeParam.xxx;
	r4 = tex2D(g_OcclusionSampler, i.texcoord.zwzw);
	r4.zw = -r4.xy + 1;
	r4.xy = g_ambientRate.ww * r4.zw + r4.xy;
	r1.yzw = g_cubeParam.www * r4.yyy + r1.yzw;
	...
	r2.x = r3.w * i.color.w;
	r4.yzw = lerp(r3.xyz, r0.xyz, r2.xxx);
	r2.xyz = g_ColorEnhance.xyz * i.color.xyz;
	r3.xyz = r4.yzw * r2.xyz + g_cubeParam2.zzz;
	r0.xyz = r2.xyz * r4.yzw;
	r1.yzw = r1.yzw * r3.xyz;
	r2.x = r4.x * 0.5 + 0.5;
	r2.yzw = r4.xxx * r0.xyz;
	o.color = r0;
	o.color2.w = r0.w;
	r0.x = r2.x * r2.x;
