...
float4 main(PS_IN i) : COLOR
{
	...
	r8.xy = g_All_Offset.xy;
	r8.xy = i.texcoord.xy * tile.xy + r8.xy;
	r8 = tex2D(normalmap_sampler, r8);
	r10 = tex2D(cubemap_sampler, i.texcoord4);
	r11 = tex2D(cubemap2_sampler, i.texcoord4);
	r12 = lerp(r11, r10, g_CubeBlendParam.x);
	...
	r11.xyz = r10.xyz * CubeParam.zzz + r1.xyw;
	r10.xyz = r10.xyz * CubeParam.zzz;
	r1.xyw = r1.xyw * -r10.xyz + r11.xyz;
	r2.x = dot(-i.texcoord1.xyz, -i.texcoord1.xyz);
	r2.x = 1 / sqrt(r2.x);
	r10.xyz = -i.texcoord1.xyz * r2.xxx + lightpos.xyz;
	r11.xyz = r2.xxx * -i.texcoord1.xyz;
	r12.xyz = normalize(r10.xyz);
	r2.x = dot(r12.xyz, i.texcoord3.xyz);
	r6.y = -r2.x + 1;
	r10.x = r6.y * -specularParam.z + r2.x;
	r10.yw = specularParam.yy;
	r12 = tex2D(Spec_Pow_sampler, r10);
	r12.xyz = r12.xyz * light_Color.xyz;
	r4.xyz = r4.xyz * r2.www + r11.xyz;
	r13.xyz = normalize(r4.xyz);
	r2.x = dot(r13.xyz, i.texcoord3.xyz);
	r2.w = -r2.x + 1;
	r10.z = r2.w * -specularParam.z + r2.x;
	r10 = tex2D(Spec_Pow_sampler, r10.zwzw);
	r4.xyz = r10.xyz * point_light1.xyz;
	r4.xyz = r3.www * r4.xyz;
	r10 = g_specCalc1;
	r4.xyz = r4.xyz * r10.xxx;
	r2.xyw = r12.xyz * r2.yyy + r4.xyz;
	r4.xyz = r5.xyz * r2.zzz + r11.xyz;
	r5.xyz = normalize(r4.xyz);
	r2.z = dot(r5.xyz, i.texcoord3.xyz);
	r3.w = -r2.z + 1;
	r12.x = r3.w * -specularParam.z + r2.z;
	r12.yw = specularParam.yy;
	r13 = tex2D(Spec_Pow_sampler, r12);
	r4.xyz = r13.xyz * point_light2.xyz;
	r4.xyz = r4.www * r4.xyz;
	r2.xyz = r4.xyz * r10.yyy + r2.xyw;
	r3.xyz = r3.xyz * r5.www + r11.xyz;
	r4.xyz = normalize(r3.xyz);
	r2.w = dot(r4.xyz, i.texcoord3.xyz);
	r3.x = -r2.w + 1;
	r12.z = r3.x * -specularParam.z + r2.w;
	r3 = tex2D(Spec_Pow_sampler, r12.zwzw);
	r3.xyz = r3.xyz * point_lightEv0.xyz;
	r3.xyz = r6.xxx * r3.xyz;
	r2.xyz = r3.xyz * r10.zzz + r2.xyz;
	r3.xyz = r7.xyz * r0.www + r11.xyz;
	r4.xyz = r9.xyz * r6.www + r11.xyz;
	r5.xyz = normalize(r4.xyz);
